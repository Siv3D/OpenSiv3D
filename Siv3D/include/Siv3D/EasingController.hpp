...
namespace s3d
{
	...
	public:
		...
		[[nodiscard]] Type easeInOut() const
		{
			if (m_swapped)
			{
		...
		[[nodiscard]] const Type& getA() const
		{
			return m_a;
		}

		[[nodiscard]] const Type& getB() const
		{
			return m_b;
		}

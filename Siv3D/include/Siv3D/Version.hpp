...
# define SIV3D_VERSION_REVISION			7
...
# define SIV3D_VERSION_SHORT_STRING	U"0.6.7"

/// @brief ライブラリのバージョンの文字列 | Library version
# define SIV3D_VERSION_STRING	U"0.6.7" SIV3D_VERSION_PRERELEASE_TAG

/// @brief ライブラリのバージョン名 | Library version name
# define SIV3D_VERSION_NAME		U"Siv3D March 2023"

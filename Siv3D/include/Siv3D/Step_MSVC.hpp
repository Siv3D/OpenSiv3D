...
namespace s3d
{
	template <class T, class N, class S, bool isScalar = std::is_scalar_v<T>>
	class steps_class
	{
	public:
	...
	{
		static_assert(std::is_integral_v<N>, "step: the second parameter should be of integral type");
	...
	{
		static_assert(std::is_integral_v<N>, "step: parameter should be of integral type");
	...
	{
		static_assert(std::is_integral_v<N>, "step_backward: parameter should be of integral type");
	...
	{
		static_assert(std::is_integral_v<N>, "Iota: parameter should be of integral type");
...
{
	template <class T, class N, class S, bool isScalar>
	inline void Formatter(FormatData& formatData, const steps_class<T, N, S, isScalar>& value)
	{

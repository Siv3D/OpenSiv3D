...
namespace s3d
{
	...
	public:
		...
		RangeIterator<Array<INIKey>::const_iterator> getSectionKeys(const Section& section) const;

		RangeIterator<Array<INIKey>::const_iterator> operator [](const Section& section) const
		{

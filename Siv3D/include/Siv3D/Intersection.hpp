...
namespace s3d
{
	...
	namespace Geometry2D
	{
		...
		//bool Contains(const Circle& a, const Bezier2&			b);
		//bool Contains(const Circle& a, const Bezier3&			b);
		...
		////bool Contains(const Quad& a, const LineString&			b);
		...
		////bool Contains(const RoundRect& a, const Bezier2&		 b);
		////bool Contains(const RoundRect& a, const Bezier3&		 b);
		...
		////bool Contains(const RoundRect& a, const Ellipse&		b);
		...
		////bool Contains(const RoundRect& a, const MultiPolygon&	b);
		////bool Contains(const RoundRect& a, const LineString&	b);
		...
		////bool Contains(const Polygon& a, const Bezier2&		 b);
		////bool Contains(const Polygon& a, const Bezier3&		 b);
		...
		////bool Contains(const Polygon& a, const Ellipse&			b);
		...
		////bool Contains(const Polygon& a, const MultiPolygon&	b);
		////bool Contains(const Polygon& a, const LineString&		b);

		////bool Contains(const MultiPolygon& a, const Point&			b);
		////bool Contains(const MultiPolygon& a, const Vec2&			b);
		////bool Contains(const MultiPolygon& a, const Line&			b);
		////bool Contains(const MultiPolygon& a, const Bezier2&		 b);
		////bool Contains(const MultiPolygon& a, const Bezier3&		 b);
		////bool Contains(const MultiPolygon& a, const Rect&			b);
		////bool Contains(const MultiPolygon& a, const RectF&			b);
		////bool Contains(const MultiPolygon& a, const Circle&			b);
		////bool Contains(const MultiPolygon& a, const Ellipse&		b);
		////bool Contains(const MultiPolygon& a, const Triangle&		b);
		////bool Contains(const MultiPolygon& a, const Quad&			b);
		////bool Contains(const MultiPolygon& a, const RoundRect&		b);
		////bool Contains(const MultiPolygon& a, const Polygon&		b);
		////bool Contains(const MultiPolygon& a, const MultiPolygon&	b);
		////bool Contains(const MultiPolygon& a, const LineString&		b);
	}
}

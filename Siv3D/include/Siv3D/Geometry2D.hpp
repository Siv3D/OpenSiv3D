...
namespace s3d
{
	namespace Geometry2D
	{
		...
		//[[nodiscard]]
		//inline double Distance(const Point& a, const Bezier2& b) noexcept;

		//[[nodiscard]]
		//inline double Distance(const Point& a, const Bezier3& b) noexcept;
		...
		//[[nodiscard]]
		//inline double Distance(const Point& a, const MultiPolygon& b) noexcept;
		...
		//[[nodiscard]]
		//inline double Distance(const Vec2& a, const Bezier2& b) noexcept;
		...
		//[[nodiscard]]
		//inline double Distance(const Vec2& a, const MultiPolygon& b) noexcept;
		...
		//[[nodiscard]]
		//inline double Distance(const Line& a, const Bezier2& b) noexcept;

		//[[nodiscard]]
		//inline double Distance(const Line& a, const Bezier3& b) noexcept;
		...
		//[[nodiscard]]
		//inline double Distance(const Line& a, const Ellipse& b) noexcept;
		...
		//[[nodiscard]]
		//inline double Distance(const Line& a, const RoundRect& b) noexcept;

		[[nodiscard]]
		double Distance(const Line& a, const Polygon& b);

		//[[nodiscard]]
		//inline double Distance(const Line& a, const MultiPolygon& b) noexcept;
		...
		//[[nodiscard]]
		//inline double Distance(const Bezier2& a, const Point& b) noexcept;

		//[[nodiscard]]
		//inline double Distance(const Bezier2& a, const Vec2& b) noexcept;

		//[[nodiscard]]
		//inline double Distance(const Bezier2& a, const Line& b) noexcept;
		...
		//[[nodiscard]]
		//inline double Distance(const Bezier2& a, const Rect& b) noexcept;

		//[[nodiscard]]
		//inline double Distance(const Bezier2& a, const RectF& b) noexcept;
		...
		//[[nodiscard]]
		//inline double Distance(const Bezier2& a, const Triangle& b) noexcept;

		//[[nodiscard]]
		//inline double Distance(const Bezier2& a, const Quad& b) noexcept;
		...
		//[[nodiscard]]
		//inline double Distance(const Rect& a, const Bezier2& b) noexcept;

		//[[nodiscard]]
		//inline double Distance(const Rect& a, const Bezier3& b) noexcept;
		...
		//[[nodiscard]]
		//inline double Distance(const Rect& a, const RoundRect& b);

		[[nodiscard]]
		double Distance(const Rect& a, const Polygon& b);

		//[[nodiscard]]
		//inline double Distance(const Rect& a, const MultiPolygon& b);
		...
		//[[nodiscard]]
		//inline double Distance(const RectF& a, const RoundRect& b);

		[[nodiscard]]
		double Distance(const RectF& a, const Polygon& b);

		//[[nodiscard]]
		//inline double Distance(const RectF& a, const MultiPolygon& b);

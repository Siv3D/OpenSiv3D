...
namespace s3d
{
	inline ScopedRenderTarget3D::ScopedRenderTarget3D(const Optional<RenderTexture>& rt)
	...
	inline ScopedRenderTarget3D::ScopedRenderTarget3D(ScopedRenderTarget3D&& other) noexcept
	{

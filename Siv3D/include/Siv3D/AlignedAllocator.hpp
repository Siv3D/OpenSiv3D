...
namespace s3d
{
	...
	public:
		...
		static_assert(!std::is_const_v<Type>, "AlignedAllocator<const Type> is ill-formed.");
	...
	{
		using type = std::conditional_t<IsOverAligned_v<Type>, AlignedAllocator<Type>, std::allocator<Type>>;
	};
}

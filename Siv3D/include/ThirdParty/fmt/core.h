...
typedef basic_string_view<char32_t> wstring_view;
...
typedef basic_buffer<char32_t> wbuffer;
...
typedef basic_parse_context<char32_t> wparse_context;
...
typedef buffer_context<char32_t>::type wformat_context;
...
template <typename T>
inline internal::named_arg<T, char32_t> arg(wstring_view name, const T &arg) {
...
template <typename... Args>
inline std::u32string format(wstring_view format_str, const Args & ... args) {

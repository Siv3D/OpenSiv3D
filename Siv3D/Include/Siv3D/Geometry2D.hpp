...
namespace s3d
{
	...
	namespace Geometry2D
	{
		...
		//bool Intersect(const Point& a, const RoundRect&		b);
		...
		//bool Intersect(const Vec2& a, const Point&			b);
		...
		//bool Intersect(const Line& a, const Point&			b);
		...
		//bool Intersect(const Rect& a, const Vec2&			b);
		...
		//bool Intersect(const Rect& a, const RoundRect&		b);
		//bool Intersect(const Rect& a, const Polygon&		b);
		...
		//bool Intersect(const Triangle& a, const Point&			b);
		//bool Intersect(const Triangle& a, const Vec2&			b);
		//bool Intersect(const Triangle& a, const Line&			b);
		//bool Intersect(const Triangle& a, const Rect&			b);
		...
		//bool Intersect(const Quad& a, const Point&				b);
		//bool Intersect(const Quad& a, const Vec2&				b);
		//bool Intersect(const Quad& a, const Line&				b);
		//bool Intersect(const Quad& a, const Rect&				b);
		...
		//bool Intersect(const RoundRect& a, const Point&			b);
		//bool Intersect(const RoundRect& a, const Vec2&			b);
		//bool Intersect(const RoundRect& a, const Line&			b);
		//bool Intersect(const RoundRect& a, const Rect&			b);
		...
		//bool Intersect(const Polygon& a, const Point&			b);
		//bool Intersect(const Polygon& a, const Vec2&			b);
		//bool Intersect(const Polygon& a, const Line&			b);
		//bool Intersect(const Polygon& a, const Rect&			b);

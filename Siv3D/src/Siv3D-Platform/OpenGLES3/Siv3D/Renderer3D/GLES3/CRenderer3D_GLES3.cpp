...
namespace s3d
{
	...
	void CRenderer3D_GLES3::addMesh(const Mesh& mesh, const Mat4x4& mat, const Float4& color)
	{
	...
	void CRenderer3D_GLES3::addTexturedMesh(const Mesh& mesh, const Texture& texture, const Mat4x4& mat, const Float4& color)
	{
		if (not m_currentCustomVS)
		{
			m_commandManager.pushStandardVS(m_standardVS->forwardID);

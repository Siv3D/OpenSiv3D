...
namespace s3d
{
	...
	public:
		...
		[[nodiscard]]
		VertexLine3DBufferPointer requestBuffer(VertexLine3D::IndexType vertexSize, uint32 indexSize, D3D11Renderer3DCommandManager& commandManager);

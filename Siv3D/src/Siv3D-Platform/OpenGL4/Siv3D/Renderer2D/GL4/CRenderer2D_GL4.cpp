...
namespace s3d
{
	...
	void CRenderer2D_GL4::addCircleArc(const Float2& center, const float rInner, const float startAngle, const float angle, const float thickness, const Float4& innerColor, const Float4& outerColor)
	{

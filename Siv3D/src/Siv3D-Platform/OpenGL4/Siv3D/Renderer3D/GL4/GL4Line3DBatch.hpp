...
namespace s3d
{
	...
	public:
		...
		[[nodiscard]]
		VertexLine3DBufferPointer requestBuffer(VertexLine3D::IndexType vertexSize, uint32 indexSize, GL4Renderer3DCommandManager& commandManager);

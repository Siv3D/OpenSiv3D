...
# endif
	...
	public:
		...
		void pushInputLayout(GL4InputLayout3D state);
		const GL4InputLayout3D& getInputLayout(uint32 index) const;
		const GL4InputLayout3D& getCurrentInputLayout() const;

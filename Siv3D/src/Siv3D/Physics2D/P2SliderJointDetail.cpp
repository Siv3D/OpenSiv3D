...
namespace s3d
{
	detail::P2SliderJointDetail::P2SliderJointDetail(const std::shared_ptr<detail::P2WorldDetail>& world, const P2Body& bodyA, const P2Body& bodyB, const Vec2& worldAnchorPos, const Vec2& normalizedAxis)
		: m_world{ world }

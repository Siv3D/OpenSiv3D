...
namespace s3d
{
	...
	void RegisterImage(asIScriptEngine* engine)
	{
		...
		r = engine->RegisterObjectMethod("LineString", "const LineString& overwrite(Image& inout, const Color& in, bool antialiased = true) const", asMETHODPR(LineString, overwrite, (Image&, const Color&, bool) const, const LineString&), asCALL_THISCALL); assert(r >= 0);
		r = engine->RegisterObjectMethod("LineString", "const LineString& overwrite(Image& inout, int32, const Color& in, bool antialiased = true) const", asMETHODPR(LineString, overwrite, (Image&, int32, const Color&, bool) const, const LineString&), asCALL_THISCALL); assert(r >= 0);
		r = engine->RegisterObjectMethod("LineString", "const LineString& overwriteClosed(Image& inout, const Color& in, bool antialiased = true) const", asMETHODPR(LineString, overwriteClosed, (Image&, const Color&, bool) const, const LineString&), asCALL_THISCALL); assert(r >= 0);
		r = engine->RegisterObjectMethod("LineString", "const LineString& overwriteClosed(Image& inout, int32, const Color& in, bool antialiased = true) const", asMETHODPR(LineString, overwriteClosed, (Image&, int32, const Color&, bool) const, const LineString&), asCALL_THISCALL); assert(r >= 0);

...
namespace s3d
{
	...
	//static double EaseInCB(asIScriptFunction* cb, double t)
	//{
	//	return t * 0.5;
	//}
	...
	void RegisterEasing(asIScriptEngine* engine)
	{
		...
		//engine->RegisterFuncdef("double EasingFunction(double)");
		//r = engine->RegisterGlobalFunction("double EaseIn(EasingFunction@, double)", asFUNCTION(EaseInCB), asCALL_CDECL); assert(r >= 0);

...
namespace s3d
{
	Audio_X27::Audio_X27(Wave&& wave, AudioDevice_X27* const device, const Optional<AudioLoopTiming>& loop, const double maxSpeed)
		: m_device(device)
	...
	VoiceStream_X27& Audio_X27::getStream()
	{
		return m_stream;
	}

	const VoiceStream_X27& Audio_X27::getStream() const
	{
		return m_stream;
	}

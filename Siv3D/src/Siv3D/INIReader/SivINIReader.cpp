...
namespace s3d
{
	...
	TextEncoding INIReader::encoding() const
	{
	...
	RangeIterator<Array<INIKey>::const_iterator> INIReader::getSectionKeys(const Section& section) const
	{
		...
		return RangeIterator<Array<INIKey>::const_iterator>(first, itEnd);
	}

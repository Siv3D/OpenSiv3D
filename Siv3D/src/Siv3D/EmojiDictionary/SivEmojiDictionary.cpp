...
namespace s3d
{
	EmojiDictionary::EmojiDictionary()
		: pImpl(std::make_shared<CEmojiDictionary>())
	{
...
void Main()
{
	BinaryWriter writer(L"dictionary.dat");

	for (const auto& emojiCodePoint : emojiCodePoints)
	{
		writer.write(uint32(emojiCodePoint.size()));
		writer.write(emojiCodePoint);
	}
}
*/

...
namespace s3d
{
	...
	bool CProfiler::reportAssetNextFrame()
	{
		...
		{
			LOG_ERROR(L"🔥 Assets have been created and released every frame. Set Profiler::EnableAssetCreationWarning(false) to suppress this assertion.");

			System::ShowMessageBox(L"Asset creation report", L"🔥 Assets have been created and released every frame. Set Profiler::EnableAssetCreationWarning(false) to suppress this assertion.", MessageBoxStyle::Error);

...
|:---------------:|:---------------:|:-------------:|:------------------------------|
| Windows | [**0.4.1**](https://siv3d.github.io/#getting-started) | ?? ??? 2019 | - Windows 7 SP1 / 8.1 / 10 (64-bit)<br>- Microsoft Visual C++ 2019 16.3<br>- Windows 10 SDK |
| macOS           | [**0.4.1**](https://siv3d.github.io/#getting-started) | ?? ??? 2019 | - macOS High Sierra v10.13 or newer<br>- Xcode 10.1 or newer<br>- OpenGL 4.1 compatible graphics card |
| Linux           | [**0.4.1**](https://siv3d.github.io/#getting-started)* | ?? ??? 2019 | - Tested compilers: Clang 8.0.0 / GCC 8.3.0<br>- OpenGL 4.1 compatible graphics card |
| iOS | TBA  |  |  |

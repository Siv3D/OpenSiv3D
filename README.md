...
|:------------------:|:----------:|:------------------------------|
| Windows            | [**Download SDK**](https://siv3d.jp/downloads/Siv3D/OpenSiv3D_0.6.0_Installer.exe)<br>115 MB<br>*18 September 2021* | - Windows 7 SP1 / 8.1 / Windows 10 (64-bit)<br>- Microsoft Visual C++ 2019 16.10 or newer<br>- Windows 10 SDK<br>- Intel / AMD CPU |
| macOS              | [**Download SDK**](https://siv3d.jp/downloads/Siv3D/siv3d_v0.6.0_macOS.zip)<br>172 MB<br>*18 September 2021* | - macOS Mojave / Catalina / Big Sur<br>- Xcode 11.3 or newer (Big Sur requires Xcode 12.5)<br>- Intel CPU<br>- OpenGL 4.1 compatible hardware |
...
| Platform        | SDK   D| Requirements                  |
|:---------------:|:----------------------------:|:------------------------------|
| Windows | [**Download SDK**](https://siv3d.jp/downloads/Siv3D/OpenSiv3D(0.4.3)Installer.exe)<br>83 MB<br>*11 April 2020* | - Windows 7 SP1 / 8.1 / 10 (64-bit)<br>- Microsoft Visual C++ 2019 16.4<br>- Windows 10 SDK |
| macOS           | [**Download SDK**](https://siv3d.jp/downloads/Siv3D/siv3d_v0.4.3_macOS.zip)<br>103 MB<br>*11 April 2020* | - macOS Mojave v10.14 or newer<br>- Xcode 11.3 or newer<br>- OpenGL 4.1 compatible graphics card |

...
void Main()
{
	...
	//const PixelShader gaussianBlur(U"example/shader/gaussian_blur_5.frag", {{ U"PSConstants2D", 0 }});
	//const PixelShader gaussianBlur(U"example/shader/gaussian_blur_9.frag", {{ U"PSConstants2D", 0 }});
	const PixelShader gaussianBlur(U"example/shader/gaussian_blur_13.frag", {{ U"PSConstants2D", 0 }});
